...
Cette formation correspond parfaitement aux attendus techniques du Master MEEF Informatique \parencite{master_meef_nantes}, couvrant l'ensemble des domaines techniques enseignés en NSI \parencite{eduscol_nsi}.
...
\begin{itemize}[leftmargin=*]
    \item \textbf{Solidité technique} : DUT + BTS + certifications professionnelles couvrent tous les domaines de l'informatique
    ...
    \item \textbf{Légitimité pédagogique} : CAPES + CAPET valident les compétences d'enseignement
\end{itemize}
