...
Cette année, je suis pleinement engagé en tant qu'enseignant PRCE en IUT, au sein du département Techniques de Commercialisation de l'IUT du Havre (où j'assure les enseignements de Ressources et Culture Numérique), et j'ai pris la fonction de \textbf{Directeur Adjoint de l'IUT du Havre dédié aux questions du numérique}. Cette nomination et cette transition, effectives depuis l'année universitaire 2025-2026, marquent une étape majeure dans mon parcours professionnel, me confiant la responsabilité du pilotage stratégique de la transformation numérique, de la gouvernance des équipements et de l'intégration de l'IA à l'échelle de l'institut, après cinq années d'enseignement des Sciences Numériques et Technologie (SNT) et de la spécialité Numérique et Sciences Informatiques (NSI) en lycée \parencite{eduscol_nsi,nsi_programmes}.
