...
La solidité de ma formation initiale en informatique, acquise à l'IUT du Havre puis complétée par de nombreuses certifications professionnelles, a constitué le socle d'une carrière industrielle de 15 ans dans des environnements techniques exigeants. Cette expertise approfondie des systèmes, réseaux et développement logiciel correspond aux compétences techniques et d'ingénierie numérique du Master MEEF PIF \parencite{referentiel_meef}, couvrant notamment la programmation, l'algorithmique, l'architecture des ordinateurs et les réseaux.
