...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Master MEEF Informatique} (Second Degré - Parcours NSI) - 2026
\end{itemize}
...
Personnes pouvant attester de l'expérience, des compétences et du parcours professionnel :

\begin{itemize}[leftmargin=*]
    \item \textbf{Hugues DUFLO} — Directeur de l'IUT Le Havre : Supervision de la gouvernance de l'établissement et de la direction adjointe dédiée aux questions du numérique.
    \item \textbf{Mickaël MILLET} — Chef du département Techniques de Commercialisation (TC), IUT Le Havre : Responsable pédagogique, supervision des enseignements et évaluation IUT.
    \item \textbf{Élisabeth SCHNEIDER} — Enseignante-chercheuse (ESO UMR 6590 / CIRNEF, Unicaen), INSPÉ de Normandie Caen : Accompagnatrice méthodologique VAE et référente pédagogique.
    \item \textbf{Yohan BARREY} — Chef d'établissement (2020-2025) : Supervision directe des activités d'enseignement de la spécialité NSI et SNT en lycée.
    \item \textbf{Patrice DELAMARE} — Proviseur, Lycée Pierre Corneille (Rouen) : Évaluation des compétences lors du stage de pratique.
    \item \textbf{Sandrine TETART} — Enseignante NSI : Collaboration pédagogique, co-conception de séquences et échanges de pratiques.
\end{itemize}

\textit{Les coordonnées détaillées de ces références sont disponibles sur demande pour préserver la confidentialité des données personnelles (RGPD).}
