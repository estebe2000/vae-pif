...
\begin{itemize}
    ...
    \item \textbf{Utilité VAE :} Essentiel pour l'expérience SQL (Chap 9). Vous montrez comment vous avez transformé le concept abstrait de "modèle relationnel" en une activité concrète de "rétro-ingénierie", opérant une transposition didactique interne consciente.
