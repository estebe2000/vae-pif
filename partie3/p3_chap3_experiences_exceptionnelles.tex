...
\hline
\textbf{Bloc RNCP} & \textbf{SQL} & \textbf{JEUX} & \textbf{ÉVAL} \\
\hline
\textbf{BC01} & ++ & +++ & ++ \\
\hline
\textbf{BC02} & +++ & ++ & ++ \\
...
\subsubsection{Expérience SQL - Ingénierie didactique par rétro-ingénierie}

\textbf{Points forts} :
\begin{itemize}[leftmargin=*]
    \item \textbf{BC02/BC05} : Conception d'une ingénierie didactique originale, du concret vers l'abstrait.
    \item Innovation pédagogique en créant le besoin avant d'apporter la solution.
    \item Maîtrise disciplinaire et capacité à produire des savoirs spécialisés (BC02).
    \item Analyse réflexive et régulation du dispositif (BC08/BC09).
\end{itemize}
