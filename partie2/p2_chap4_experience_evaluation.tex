...
Le dispositif d'évaluation appelé \textbf{« Notation à l'Enveloppe »} (baptisé informellement « Méthode Italienne » au sein de ma pratique enseignante, en référence à l'analogie d'une enveloppe budgétaire globale de points distribuée équitablement par les pairs) est une ingénierie d'évaluation originale que j'ai conçue et formalisée sur le terrain pour répondre aux écueils de la notation de groupe indifférenciée.
