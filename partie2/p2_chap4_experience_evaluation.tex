...
\subsection{Le point de départ : de la pratique du projet (Expérience 2) au besoin d'ingénierie d'évaluation}

Cette démarche d'ingénierie de l'évaluation est née directement de mon analyse réflexive sur les projets collaboratifs interdisciplinaires (tels que le PCI Jeu Vidéo présenté à l'Expérience 2) et d'un double constat professionnel théorisé dans la littérature en ingénierie de formation \parencite{evaluation_pairs_utc,evaluation_pairs_univ_poitiers,scallon_evaluation} :

\begin{enumerate}[leftmargin=*]
    \item \textbf{Le risque d'injustice redistributive} : Dans la notation de groupe indifférenciée, l'attribution d'une note unique identique occulte les écarts d'investissement réel, créant de la frustration chez les apprenants moteurs et un risque de déresponsabilisation.
...
Cette expérimentation s'inscrit donc dans le cœur de compétences du Master MEEF PIF / FFMS : l'\textbf{ingénierie des dispositifs d'évaluation régulatrice} \parencite{perrenoud_pratique_reflexive,nicol_formative_assessment}, visant à transformer l'évaluation sommative subie en un vecteur d'auto-régulation, de métacognition et d'apprentissage sociocognitif.
