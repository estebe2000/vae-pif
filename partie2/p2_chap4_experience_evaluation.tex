...
\subsubsection{Exemple d'illustration : inversion du sentiment d'injustice et fin de l'impunité}

Pour illustrer concrètement le fonctionnement du dispositif et son impact psycho-pédagogique sur le groupe-classe, prenons une situation fréquemment rencontrée en pédagogie par projet :

\begin{quote}
\textbf{Situation type :} Un groupe initial de 3 élèves réalise un projet qui mérite une évaluation globale de \textbf{12/20}. Si un 4\textsuperscript{e} élève peu investi s'incruste au dernier moment dans ce groupe sans fournir un travail régulier, le système traditionnel d'évaluation attribue mécaniquement un 12/20 indifférencié aux 4 membres. Cette notation produit une vive frustration chez les 3 élèves moteurs et entretient un sentiment d'impunité chez le passager clandestin.

\textbf{Régulation par la Notation à l'Enveloppe :} L'enseignant évalue le produit collectif à 12/20 et alloue une enveloppe budgétaire globale proportionnelle à l'effectif : $12 \times 4 = \mathbf{48\text{ points}}$. Lors de la concertation intra-groupe appuyée sur la grille d'implication, le 4\textsuperscript{e} élève, n'ayant presque rien produit, se voit attribuer une note individuelle de 4/20. Le solde du capital ($48 - 4 = 44\text{ points}$) est redistribué entre les 3 membres d'origine, dont les notes individuelles grimpent à \textbf{14,6/20} ($44 / 3 \approx 14,6$).
\end{quote}

\paragraph{Souveraineté de l'évaluateur et cadre éthique :} Cet exemple illustre le modèle théorique de calcul. Il convient de préciser que \textbf{seul l'enseignant ou formateur est investi du pouvoir d'évaluation institutionnelle et fixe les notes finales}. La proposition de répartition élaborée par les apprenants constitue un \textbf{outil consultatif d'auto-régulation} et un support de dialogue. L'enseignant s'appuie fortement sur cette proposition pour apprécier la dynamique interne du groupe, mais n'est aucunement contraint de la suivre aveuglément. Il conserve toute latitude pour réajuster les notes individuelles s'il identifie un biais d'évaluation (tel qu'une complaisance excessive, une minoration punitive ou une pression de pairs).

Ce mécanisme transforme la dynamique psychosociale du groupe :
\begin{itemize}[leftmargin=*]
    \item \textbf{Rassurance des apprenants moteurs} : Présentée dès le lancement du projet, cette règle garantit aux élèves investis que leur effort bénéficiera directement à leur évaluation individuelle.
    \item \textbf{Dissuasion du passager clandestin} : Elle supprime le sentiment d'impunité des élèves habitués à se reposer sur le travail d'autrui, incitant chacun à un engagement régulier.
\end{itemize}
