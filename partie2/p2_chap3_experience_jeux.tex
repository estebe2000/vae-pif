...
Cette structure matricielle impliquait au total \textbf{5 enseignants de disciplines différentes et environ 40 élèves}, démontrant une capacité exceptionnelle de coordination et de leadership pédagogique \parencite{competences_transversales}.
...
La démarche suivie (Analyse du problème → Conception d'une solution → Mise en œuvre → Analyse des résultats) est celle d'un praticien-chercheur \parencite{schon_reflective_practitioner,recherche_action_education}. Cette recherche-action valide une approche pédagogique complexe et démontre une autonomie qui dépasse largement les attendus d'un enseignant stagiaire.
