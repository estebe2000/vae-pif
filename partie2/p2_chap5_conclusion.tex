...
\subsubsection{L'investigation guidée (Expérience 1)}

La séance de rétro-ingénierie SQL démontre ma maîtrise de \textbf{l'accompagnement à la découverte}. Cette approche constructiviste \parencite{vygotsky_mind_society,constructivisme_education} place l'élève en position d'enquêteur, développant son autonomie intellectuelle tout en garantissant l'atteinte des objectifs curriculaires. Cette méthode révèle ma capacité à concevoir des situations didactiques complexes où la transposition s'opère naturellement du concret vers l'abstrait \parencite{chevallard_transposition}.
...
\begin{enumerate}[leftmargin=*]
    \item \textbf{Maîtrise didactique} (Exp. 1) : Conception d'une séance innovante mais circonscrite
    \item \textbf{Orchestration systémique} (Exp. 2) : Coordination d'un écosystème éducatif complexe
    \item \textbf{Innovation méthodologique} (Exp. 3) : Création d'un outil pédagogique transférable
\end{enumerate}
...
Mon affectation actuelle en BUT Informatique à l'IUT d'Angers confirme la pertinence et la transférabilité de ces compétences vers l'enseignement supérieur :
...
Cette analyse approfondie de trois expériences professionnelles révèle un niveau de maîtrise et d'innovation pédagogique qui valide les compétences du Master MEEF Informatique. Plus qu'une simple validation d'acquis, ce travail réflexif constitue un tremplin vers une carrière d'enseignant-chercheur en sciences de l'éducation.
