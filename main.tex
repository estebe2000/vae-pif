...
\hypersetup{
    ...
    urlcolor=cyan,
    citecolor=green,
    pdftitle={Dossier VAE Master MEEF Informatique - Steeve PYTEL},
...
\begin{tcolorbox}[colback=lightgray!30,colframe=gray,title=\textbf{ENCADREMENT},fonttitle=\large\bfseries]
    \textbf{ACCOMPAGNATEUR VAE :} [Nom de l'accompagnateur à Caen]\\
    \textit{Responsable du parcours Formation de formateurs}\\
    INSPÉ Normandie Caen @ Université de Caen Normandie\\
    
    \vspace{0.5cm}
    \textbf{ENSEIGNANT RÉFÉRENT :} Florian Ouitre
\end{tcolorbox}
...
\begin{itemize}[leftmargin=*, nosep]
    \item \textbf{Emmanuel DESMONTILS}, Co-responsable du parcours Informatique du master MEEF 2nd degré à l'INSPÉ de Nantes, pour son accompagnement méthodologique exceptionnel, ses conseils précieux et son expertise dans l'élaboration de ce dossier. Sa double compétence de chercheur (membre du LS2N, équipe VELO) et de pédagogue (Directeur adjoint de l'IREM Pays de Loire) a été déterminante dans la structuration de ma réflexion.
    \item L'équipe pédagogique de l'INSPÉ Académie de Nantes, pour leur disponibilité et leur expertise
...
\textbf{Agile} : Méthodologie de développement logiciel privilégiant l'adaptabilité, la collaboration et la livraison itérative de fonctionnalités.
...
\textbf{Architecture des systèmes} : Organisation structurelle des composants matériels et logiciels d'un système informatique.
\end{tcolorbox}
...
\textbf{Compétences transversales} : Aptitudes mobilisables dans différents contextes professionnels et disciplinaires.

\textbf{CREN} : Centre de Recherche en Éducation de Nantes, laboratoire de recherche en sciences de l'éducation.
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=headercolor,title=\textbf{D},fonttitle=\large\bfseries]
\textbf{DevOps} : Pratiques visant à unifier le développement logiciel et l'administration des infrastructures informatiques.
...
\textbf{EIAH (Environnements Informatiques pour l'Apprentissage Humain)} : Champ de recherche et dispositifs numériques conçus pour favoriser et accompagner l'apprentissage.
...
\textbf{Git} : Système de contrôle de version distribué pour le suivi des modifications du code source.

\textbf{GitLab} : Plateforme web de gestion de dépôts Git intégrant des outils de développement collaboratif.
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=headercolor,title=\textbf{I},fonttitle=\large\bfseries]
\textbf{IA (Intelligence Artificielle)} : Technologies permettant aux machines de simuler l'intelligence humaine.

\textbf{IDE (Integrated Development Environment)} : Environnement de développement intégré regroupant les outils de programmation.

\textbf{INSPÉ} : Institut National Supérieur du Professorat et de l'Éducation, établissement de formation des enseignants.

\textbf{IUT} : Institut Universitaire de Technologie, établissement d'enseignement supérieur technologique.
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=headercolor,title=\textbf{L},fonttitle=\large\bfseries]
\textbf{LS2N} : Laboratoire des Sciences du Numérique de Nantes, unité mixte de recherche en informatique.
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=headercolor,title=\textbf{M},fonttitle=\large\bfseries]
\textbf{Machine Learning} : Sous-domaine de l'intelligence artificielle permettant aux machines d'apprendre automatiquement.

\textbf{MEEF} : Métiers de l'Enseignement, de l'Éducation et de la Formation.

\textbf{Métacognition} : Connaissance et régulation de ses propres processus cognitifs.

\textbf{Méthodes agiles} : Approches de gestion de projet privilégiant l'adaptation au changement et la satisfaction client.
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=headercolor,title=\textbf{N},fonttitle=\large\bfseries]
\textbf{NSI} : Numérique et Sciences Informatiques. Spécialité du baccalauréat général créée en 2019.
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=headercolor,title=\textbf{O},fonttitle=\large\bfseries]
\textbf{Open Source} : Logiciel dont le code source est librement accessible, modifiable et distribuable.
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=headercolor,title=\textbf{P},fonttitle=\large\bfseries]
\textbf{PCI (Projet Collaboratif Interdisciplinaire)} : Modalité pédagogique du BUT associant plusieurs disciplines autour d'un projet commun.

\textbf{Pédagogie active} : Approches pédagogiques plaçant l'apprenant au centre de son apprentissage par l'action et l'expérimentation.

\textbf{Pédagogie de projet} : Méthode d'enseignement basée sur la réalisation d'un projet concret par les apprenants.

\textbf{POO (Programmation Orientée Objet)} : Paradigme de programmation basé sur le concept d'objets contenant des données et des méthodes.

\textbf{Praticien-chercheur} : Enseignant qui adopte une posture de recherche sur sa propre pratique, articulant savoirs théoriques et savoirs d'action pour améliorer l'enseignement.

\textbf{Python} : Langage de programmation interprété, multi-paradigme et multiplateformes.
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=headercolor,title=\textbf{R},fonttitle=\large\bfseries]
\textbf{Recherche-action} : Méthode de recherche appliquée visant à résoudre des problèmes concrets tout en produisant des connaissances.

\textbf{Réflexivité} : Capacité à analyser et questionner sa propre pratique professionnelle.

\textbf{RGPD (Règlement Général sur la Protection des Données)} : Règlement européen encadrant le traitement des données personnelles.
...
\textbf{Scrum} : Framework agile de gestion de projets privilégiant les itérations courtes et l'adaptation continue.

\textbf{SNT (Sciences Numériques et Technologie)} : Enseignement de culture générale numérique obligatoire en classe de seconde générale et technologique.

\textbf{SQL (Structured Query Language)} : Langage informatique normalisé servant à exploiter les bases de données relationnelles.
\end{tcolorbox}
...
\begin{tcolorbox}[colback=white,colframe=headercolor,title=\textbf{U},fonttitle=\large\bfseries]
\textbf{UML (Unified Modeling Language)} : Langage de modélisation graphique pour visualiser, spécifier et documenter les systèmes logiciels.

\textbf{User Experience (UX)} : Qualité de l'expérience vécue par l'utilisateur lors de l'interaction avec un produit ou service.
\end{tcolorbox}
...
\textbf{Versioning} : Gestion des différentes versions d'un projet logiciel au cours de son développement.
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=headercolor,title=\textbf{W},fonttitle=\large\bfseries]
\textbf{Web développement} : Création et maintenance de sites web, incluant la conception, la programmation et la gestion de contenu.
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=headercolor,title=\textbf{Z},fonttitle=\large\bfseries]
\textbf{ZPD (Zone Proximale de Développement)} : Concept de Vygotsky désignant l'écart entre ce qu'un apprenant peut faire seul et ce qu'il peut faire avec une aide.
\end{tcolorbox}
...
\setcounter{page}{1}
\part[Description du parcours]{Description du parcours \\ \vspace{2cm} \includegraphics[width=0.8\textwidth]{sources/medias/p1-moy.png} \\ \vspace{0.5cm} \small \textit{Illustration réalisée avec NotebookLM}}
\include{partie1/p1_chap1_introduction}
\include{partie1/p1_chap2_description_parcours}
\include{partie1/p1_chap3_formation_initiale}
\include{partie1/p1_chap4_formation_continue}
\include{partie1/p1_chap5_parcours_detaille}
\include{partie1/p1_chap6_autres_experiences}
\include{partie1/p1_chap7_bilan}

% ---------------------------
% PARTIE 2 : ANALYSE DES EXPÉRIENCES
% ---------------------------
\part[Description et analyse des expériences professionnelles]{Description et analyse des expériences professionnelles \\ \vspace{2cm} \includegraphics[width=0.8\textwidth]{sources/medias/p2-moy.png} \\ \vspace{0.5cm} \small \textit{Illustration réalisée avec NotebookLM}}
\include{partie2/p2_chap1_introduction}
\include{partie2/p2_chap2_experience_sql}
\include{partie2/p2_chap3_experience_jeux}
\include{partie2/p2_chap4_experience_evaluation}
\include{partie2/p2_chap5_conclusion}

% ---------------------------
% PARTIE 3 : CORRESPONDANCE RNCP ET PROJET
% ---------------------------
\part[Correspondance avec le référentiel RNCP et synthèse des acquis]{Correspondance avec le référentiel RNCP et synthèse des acquis \\ \vspace{2cm} \includegraphics[width=0.8\textwidth]{sources/medias/p3-moy.png} \\ \vspace{0.5cm} \small \textit{Illustration réalisée avec NotebookLM}}
\include{partie3/p3_chap1_introduction}
\include{partie3/p3_chap2_analyse_competences}
\include{partie3/p3_chap3_experiences_exceptionnelles}
\include{partie3/p3_chap4_synthese_correspondance}
\include{partie3/p3_chap5_projet_professionnel}
...
Cette démarche de Validation des Acquis de l'Expérience dépasse largement le cadre d'une simple reconnaissance de compétences. Elle constitue l'aboutissement d'une trajectoire professionnelle cohérente et l'acte fondateur d'un engagement renouvelé dans l'éducation et la formation. À travers l'analyse approfondie de mon parcours professionnel et des trois expériences pédagogiques présentées, ce dossier révèle une adéquation exceptionnelle avec les exigences du Master MEEF Informatique tel que défini par le référentiel RNCP38356 \parencite{rncp38356}.
...
\subsection*{Validation d'un parcours d'excellence}

L'analyse approfondie de mon parcours révèle un niveau de maîtrise qui dépasse largement les attendus du Master MEEF Informatique. Les compétences développées, la capacité d'innovation démontrée, l'impact sur la communauté éducative et le projet de recherche structuré positionnent cette candidature VAE comme exceptionnelle.

Plus qu'une validation d'acquis, ce dossier constitue la démonstration d'une expertise pédagogique de haut niveau, immédiatement transférable vers l'enseignement supérieur et la recherche. Cette expertise, nourrie par une expérience industrielle solide et une pratique réflexive mature, représente une contribution unique au paysage de l'enseignement de l'informatique en France.

\subsection*{Positionnement pour l'avenir}

L'obtention du Master MEEF Informatique par VAE me permettra de concrétiser pleinement mon projet professionnel d'enseignant-chercheur. Cette reconnaissance institutionnelle de mes compétences ouvrira la voie à :
...
C'est dans cet esprit que j'envisage ma future carrière d'enseignant-chercheur : accompagner les étudiants dans la construction de leur propre savoir, stimuler leur créativité et développer leur esprit critique. Ma démarche VAE n'est ainsi pas une fin en soi, mais le point de départ d'un nouvel engagement au service de la transmission et de l'innovation pédagogique.
...
% ===========================
\part[Annexes Illustratives]{Annexes Illustratives \\ \vspace{2cm} \includegraphics[width=0.8\textwidth]{sources/medias/p4-moy.png} \\ \vspace{0.5cm} \small \textit{Illustration réalisée avec NotebookLM}}
\include{annexes/pedagogiques/p4_chap1_pedagogiques}
\include{annexes/administratives/p4_chap2_administratives}
